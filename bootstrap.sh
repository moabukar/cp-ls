...
kubectl apply -f manifests/provider-aws-apigw.yml || error_exit "Failed to apply AWS API Gateway provider."
kubectl apply -f manifests/provider-aws-lambda.yml || error_exit "Failed to apply AWS Lambda provider."
kubectl apply -f manifests/provider-aws-iam.yml || error_exit "Failed to apply AWS IAM provider."
